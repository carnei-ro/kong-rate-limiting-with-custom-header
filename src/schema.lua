...
return {
    ...
    { config = {
        ...
        fields = {
          ...
          { limit_by = {
              type = "string",
              default = "consumer",
              one_of = { "consumer", "credential", "ip", "service", "custom_header" },
          }, },
          { custom_header = { type = "string", len_min = 0 }, },
          { policy = {
              type = "string",
              default = "cluster",
              len_min = 0,
  ...
  entity_checks = {
    ...
    { conditional = {
      if_field = "config.limit_by", if_match = { eq = "custom_header" },
      then_field = "config.custom_header", then_match = { required = true },
    } },
    { conditional = {
      if_field = "config.policy", if_match = { eq = "redis" },
