...
config:
	...
	@curl -i -X POST http://localhost:8001/services/httpbin/plugins -d "name=${NAME}" -d "config.policy=local" -d "config.limit_by=custom_header" -d "config.custom_header=X-My-Header" -d "config.minute=5"
...
config_test:
	@curl -i -X POST http://localhost:8001/services/private/plugins -d "name=${NAME}" -d "config.valid_domains=ifood.com.br"  -d "config.public_keys.12345678-1234-1234-1234-123456789ABC="
